 ...
 * Stack and components. It also include major functions for saving data.
 */

private let SQLITE_FILE_NAME = "lightstop.sqlite"
private let databaseResourceName = "LightStop"
class CoreDataStackManager {
    ...
    lazy var applicationDocumentsDirectory: URL = {
        ...
        //Instantiating the applicationDocumentDirectory property
